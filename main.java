...
public void CreateAll() throws SQLException{
        ...
        stmt.executeUpdate("CREATE TABLE Part(PID INT(3) UNSIGNED NOT NULL, PNAME CHAR(20) NOT NULL, PPRICE INT(5) UNSIGNED NOT NULL, PMID INT(2) UNSIGNED NOT NULL, PCID INT(1) UNSIGNED NOT NULL, PWAR INT(2) UNSIGNED NOT NULL, PQTY INT ")
        stmt.executeUpdate("")
}
